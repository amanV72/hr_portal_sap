...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "com/hr/employeelisttemplate/test/integration/FirstJourney",
    "com/hr/employeelisttemplate/test/integration/UsersListJourney",
    "com/hr/employeelisttemplate/test/integration/UsersObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
